...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '0bc52fc50c925ddb4789b055a9a8f8329a65e5535e4a3eb3b949ac915818e351'),
    ],
    ...
    'Cache' => [
        ...
        '_cake_core_' => [
            ...
            'servers' => ['CACHE_HOSTNAME'],
            'prefix' => 'squadMaker_cake_core_',
        ...
        '_cake_routes_' => [
            'className' => 'Cake\Cache\Engine\MemcachedEngine',
            'servers' => ['CACHE_HOSTNAME'],
            'prefix' => 'squadMaker_cake_routes_',
            'path' => CACHE,
            'serialize' => 'php',
            'duration' => '+1 years',
    ...
    'Datasources' => [
        'default' => [
            ...
            'username' => 'squadMaker',
            'password' => '8R3vhnW@X_#FGu&?assS6%=g_QGx5Z',
            'database' => 'squadMaker',
            /*
